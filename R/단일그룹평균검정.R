...
mean(time, na.rm = T) #na가 있으면 remove 할까?True 

time2<-na.omit(time) ##omit을 이용해 NA를 포함한 row를 제거! 
time2 
...
student_height <- read.csv("C:/Users/pc/r-workspace/rproject3/r-csv/csv/student_height.csv")
View(student_height)

length(student_height)
summary(student_height)
